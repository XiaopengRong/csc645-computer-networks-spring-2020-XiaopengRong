...
class Employee(object):
    ...
    def info(self):
        ...
        return '{employeeName} works in the {departmentName} department'.format(employeeName=self.name,
...
class Manager(Employee):
    ...
    def manager_info(self):
        ...
        """
        print(self.name, "works in the", self.department, "department", "with manager id:", self.managerID)
        return "{Sarah} works in the {Engineering} department with manager id: {id}".format(Sarah=self.name,
                                                                                                 Engineering=self.department,
                                                                                                 id = self.managerID)
